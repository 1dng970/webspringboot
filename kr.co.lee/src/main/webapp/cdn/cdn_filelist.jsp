...
<!--
 download : 상대 경로에서는 정상적으로 작동함, 단 절대경로 불가능
 download 속성은 http, https 불가능 하며, localhost에서 단, /abc.jpg 그리고 download =abc.jpg 가능함
  -->
 <a href="${fdata.FILE_URL}" target="_new">${fdata.NEW_FILE}</a>

<!-- <a href="./download.do?filenm=${fdata.FILE_URL}">${fdata.NEW_FILE}</a>  -->
</td>
